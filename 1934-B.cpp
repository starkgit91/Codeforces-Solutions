...
void solve(){
  ...
  dp[1]=1;dp[2]=2;dp[3]=1;dp[4]=2;dp[5]=3;dp[6]=1;dp[7]=2;dp[8]=3;dp[9]=2;dp[10]=1;dp[11]=2;dp[12]=2;dp[13]=2;dp[14]=3;dp[15]=1;
  dp[16]=2;dp[17]=3;dp[18]=2;dp[19]=3;dp[20]=2;dp[21]=2;dp[22]=3;dp[23]=3;dp[24]=4;dp[25]=2;dp[26]=3;dp[27]=3;dp[28]=3;dp[29]=4;dp[30]=2;
  if(n<=15){
    cout<<dp[n]<<endl;
    return;
  }
  ...
  res = n%15;
  if(res==5){
    cout<<(cnt+dp[res]-2)<<endl;
    return;
  }
  if(res==8){
    cout<<(cnt+dp[res]-1)<<endl; 
    return;
  }
  debug(cnt)
  cout<<cnt+dp[res]<<endl;
}
signed main()
{
#ifndef ONLINE_JUDGE
